...
public class SawonInstanceScanner_15 {
	...
	public static void writeEmp(Emp[] emp)
	{
		...
		Emp.showTitle();
		for(Emp e:emp)
			System.out.println(e.getsName()+"\t"+e.getgPay()+"\t"+e.getfSu()+"\t"+e.gettSu()+"\t"+e.getFamilySudang()+"\t"+e.getTimeSudang()+"\t"+e.getTotalPay()); //emp를 e에 대입했으니까
	}
	...
	public static void main(String[] args) {
		...
		//배열할당
		emp=new Emp[inwon]; //[inwon]인원수 만큼 입력하기
