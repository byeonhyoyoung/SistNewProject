...
public class SwingComponent_09 extends JFrame { //JFrame이 부모
	...
	public SwingComponent_09(String title) {
		super(title); //부모한테서 온 title이 옴(super먼저)
	...
	public void initDesign()
	{
		...
		lbl1.setBackground(Color.orange); //색상 안나타나면 setOpaque
		lbl1.setOpaque(true);
		this.add(lbl1);
		
		lbl2=new JLabel("해피데이", icon1, JLabel.RIGHT);
		lbl2.setBounds(10, 120, 200, 30);
	...
	public static void main(String[] args) {
		...
		new SwingComponent_09("스윙컴포넌트_9"); //...title
	}
}